...
var localRegionData= require('./regionData');
...
var regionSelector = {
    ...
    _region_init() {
        ...
        that._region_setProvinceData(data);
        that._region_setRegionDataByName();
    ...
    _region_toggleRegionSelect() {
        ...
        var show = !this.data.regionSelectShow;

        this.setData({
            regionSelectShow: show
        });
    ...
    _region_switchregionNavs(e) {
        ...
        if (index > 0) {
            ...
            if (emptyIndex > -1) {
                ...
                tip = "请先选择" + this.data.regionTexts[emptyIndex];
    ...
    _region_select(e, myChildData) {
        ...
        var regionNavs = that.data.regionNavs;
        ...
        if (level == 0) {
            ...
            parentData = this.data[`${regionName}Data`];
        }
        ...
        regionNavs = regions.concat(that.data.regionTexts.slice(level + 1));
    ...
    _region_setDistrictChild(id, childs) {
        ...
        var provinceHoverIndex = this.data.provinceHoverIndex;
        var cityHoverIndex = this.data.cityHoverIndex;
    ...
    _region_setSelect() {
        ...
        var datas = [];
        var hovers = [];
        var regionsVal = that.data.regionsVal;
        var regionLastId = that.data.regionLastId;
        ...
        for (; i < length; i++) {
            ...
            if (i == 0) {
                parentData = regionData;
                datas.push(that.data.provinceData);
            }
