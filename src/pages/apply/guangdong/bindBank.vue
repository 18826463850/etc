<template>
  <div class="page page-validbank">
      ...
      <div class="form-box">
        ...
        <div class="form-group">
          <div class="form-item">
            ...
            <div class="form-ipt">
              <input type="text" class="ipt" v-model="bankInfo.userName" placeholder="姓名（必填）" readonly="readonly" />
            </div>
          </div>
          ...
          <div class="form-item">
            ...
            <div class="form-ipt">
              <input type="text" class="ipt" placeholder="请输入身份证号" v-model="bankInfo.idCard" readonly="readonly"/>
            </div>
          </div>
          ...
          <div class="form-item">
            ...
            <div class="form-ipt ipt-bank-type">
              ...
              <div class="bank-tip"><img src="../../../assets/images/icon-down.png" /></div>
            </div>
          </div>
          ...
          <div class="form-item ">
            ...
            <div class="form-ipt">
              <input type="number" class="ipt" placeholder="请输入您的银行卡" v-model="bankInfo.needOpenAccount === 0 ?bankInfo.bankAccount : bankInfo.bankNo" v-bind:readonly="bankInfo.needOpenAccount === 0"/>
            </div>
          </div>
    ...
    <van-popup v-model="showBankPopup" position="bottom" :overlay="true">
        <van-picker show-toolbar :columns="bankList" @cancel="onBankCancel"
          @confirm="onBankConfirm" @change="onBankChange" />
    </van-popup>
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      let bankList = ["中国工商银行" , "中国农业银行" , "中国银行" , "中国建设银行" , "中国交通银行" , "中国邮政储蓄银行" ];
