          ...
          <div class="ctc">
            ...
            <div class="form-group form-car-group">
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="8" v-model="carInfo.licencePlate"  placeholder="请输入" readonly="readonly"/>
                </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30"   placeholder="请输入" v-model="carInfo.licencePlateColor"  readonly="readonly" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.carOwner"  placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.carVehicleType" placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="tel" class="ipt" maxlength="30" v-model="carInfo.hostNumberApproved"  placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.vin"  placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="100"  v-model="carInfo.carBrand"  placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.engineNo"  placeholder="请输入" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30"  v-model="carInfo.registerDate" placeholder="请输入 (例如：2018-07-12)" />
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.issueDate"  placeholder="请输入 (例如：2018-07-12)" />
                </div>
              </div>
...
<script>
  ...
  import { tip, setTimer, showLoading, hideLoading,checkName,checkLicencePlate ,stringToDate} from '@/utils'
  ...
  export default {
    ...
    data() {
      ...
      if(carInfo.licencePlateType){
        carInfo.licencePlateColor = carInfo.licencePlateType ==4 ? '绿牌' :'蓝牌'
      }
    ...
    methods: {
      ...
      async ocrVehicleFace(v) {
        ...
        hideLoading();
         ...
         console.log(data && data.code == 200 &&  data.data && typeof data.data == 'object');
      ...
      checkIsSubmit() {
        ...
        for (let d in carInfo) {
          if (required.indexOf(d)> -1 && (carInfo[d] + "").replace(/\s/g, '') === '') {
            disabled = true;
            break;
          }
        }
