    ...
    <div class="main">
      ...
      <div class="form-box">
        ...
        <div class="brick">
          ...
          <div class="ctc">
            <div class="car-type">
              <div class="item t-blue" :class="{active:carInfo.licencePlateType=='0'}" @click="selectCarType('0')">
                蓝牌
              </div>
              <div class="item t-green" :class="{active:carInfo.licencePlateType=='4'}" @click="selectCarType('4')">
                绿牌
              </div>
            </div>
          </div>
        ...
        <van-button type="primary" class="btn-default" :disabled="btnDisabled" @click="nextAction" :loading="doing" >一键办理</van-button>
