<template>
  <div class="pdfContent">
    <img class="icon-add"  src="./../../../assets/images/zoom.png" @click="iconAdd">
    <img class="icon-jian" src="./../../../assets/images/shrink.png" @click="iconJian">
    ...
    export default {
        ...
        methods: {
            ...
            iconAdd: function(){
                ...
                document.querySelectorAll('canvas')[i].style.height = this.width + '%';
                }
