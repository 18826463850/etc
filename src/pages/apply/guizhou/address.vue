<template>
  <div class="page page-address">
    <headNav> </headNav>
    <div class="main">
      <applySteps finishs="1,2,3" selected="4"></applySteps>
      <div class="form-box">
        ...
        <van-button type="primary" :loading="submiting" :disabled="btnDisabled" class="btn-default" @click="nextAction">
          下一步</van-button>
      </div>
...
<script>
  ...
  import { applyInfo, getCarInfo, getShippingInfo, getBankInfo, getApplyInfo } from '@/store/data/index';
  ...
  export default {
    ...
    methods: {
      ...
      async saveShipping(addr) {
        ...
        this.submiting = true;
        showLoading("保存中");
        res = await this.$api.addShippingInfo(addr);
        data = res && res.data;
