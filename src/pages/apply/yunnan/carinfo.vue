        ...
        <div class="brick brick-upload">
          ...
          <div class="ctc">
            <div class="upload-boxes">
              ...
              ></uploadImg>
              <uploadImg
                :imgUrl.sync="carInfo.carHeader45Img"
                @change="change45Img"
                title="上传车头45度照片"
              ></uploadImg>
            </div>
        ...
        <div class="brick">
          ...
          <div class="ctc">
            <div class="car-type">
              ...
              <div
                class="item t-green"
                :class="{active:carInfo.licencePlateType=='11'}"
                @click="selectCarType('11')"
              >绿牌</div>
            </div>
          </div>
        </div>
          ...
          <div class="ctc">
            ...
            <div class="form-group form-car-group">
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <van-radio-group v-model="carInfo.carUseType">
                    <van-radio name="1" value="1">营运</van-radio>
                    <van-radio name="2" value="2">非营运</van-radio>
                  </van-radio-group>
                </div>
              </div>
              ...
              <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="number" maxlength="30" v-model="carInfo.vehicleFrameNo"  class="ipt" placeholder="请输入" />
                </div>
              </div>-->

              <div class="form-item">
                <div class="form-tit">车架号</div>
                <div class="form-ipt">
                  <input
                    type="text"
                    maxlength="30"
              ...
              <div class="form-item">
                ...
                <div class="form-unit">个</div>
              </div>
              <div class="form-item">
                <div class="form-tit">总重量</div>
                <div class="form-ipt">
                  <input
                    type="number"
                    class="ipt"
                    maxlength="100"
                    v-model="carInfo.totalWeight"
                    placeholder="请输入总重量"
                  />
                </div>
              </div>
              ...
              <div class="form-item">
                <div class="form-tit">车辆尺寸</div>
                <div class="form-ipt">
                  <input
                    type="text"
                    class="ipt"
                    maxlength="16"
                    v-model="carInfo.overall_dimension"
                    placeholder="长 X 宽 X 高"
                  />
                </div>
                <div class="form-unit unit-mm">mm</div>
              </div>
              ...
              <!-- <div class="form-item">
                ...
                <div class="form-ipt">
                  <input type="text" class="ipt" maxlength="30" v-model="carInfo.type"  placeholder="请输入" />
                </div>
              </div>-->
            </div>
          </div>
  ...
  methods: {
    ...
    async ocrVehicleFace(v) {
      ...
      if (
        ...
        Object.assign(carInfo, {
          ...
          carBrand: data.model,
          carType: data.vehicle_type,
          licencePlateArr: data.plate_num.split(""),
          carUseType: data.use_character == "营运" ? "1" : "2",
    ...
    async ocrVehicleBack(v) {
      ...
      if (
        ...
        Object.assign(carInfo, {
          hostNumberApproved: data.appproved_passenger_capacity.replace(
            "人",
            ""
          ),
          ...
          carHeight: carHeight,
          carLength: carLength,
          totalWeight: data.unladen_mass.replace("kg", "")
        });
    ...
    async saveApplyInfo() {
      ...
      showLoading("保存中");
      res = await this.$api.saveApplyInfoInYunNan(datas);
      data = res && res.data;
    ...
    nextAction() {
      ...
      if (!carInfo.overall_dimension) {
        tip("请输入车辆尺寸");
        return;
      }

      //目前只判断客车
      carInfo.type = getCarType(parseInt(carInfo.hostNumberApproved));
