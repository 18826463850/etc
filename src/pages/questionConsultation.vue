                ...
                <div class="tab-ct" :class="{active:activeIndex == 0}">
                  ...
                  <div class="brick" v-if="answerList.length>0">
                   ...
                   <div class="brick">
                     ...
                     <div class="content">
                       <textarea maxlength="150"  class="area" placeholder="请描述您所需解答的问题，稍后我们将有客服人员为您解答！" v-model="question"> </textarea>
                ...
                <div class="tab-ct" :class="{active:activeIndex == 1}">
                    <div class="brick brick-faq" >
                        <div class="title">
                           ...
                           <router-link to="/questionList" class="more">
                             更多问题
                           </router-link>
                        </div>
                        ...
                        <div class="content">
                             <div class="question-list" >
                               <div class="item" v-for="(item ,index) in faqList">
                                 <div class="tit">
