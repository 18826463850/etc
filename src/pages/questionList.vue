  ...
  <div class="page page-morequestion">
       ...
       <div class="main">
          <div class="question-list">
            <div class="item" v-for="(item,index ) in moreQuestionList " @click="linkTo('/questionDetail?id='+item.id,item.id)" >
                 <div class="title">{{index+1}}. {{item.question}}</div>
                 <div class="more"><div class="txt">查看详情</div><div class="ico"></div></div>
            </div>
          </div>
       </div>
  </div>
