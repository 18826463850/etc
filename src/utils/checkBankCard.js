...
export const getBankCardInfo = (bankCard) =>{
  return bankCardAttribution(bankCard);
}
//console.log( bankCardAttribution('6217001210024455220'))
//console.log(decodeURIComponent('http%3A%2F%2Fwechat.sit.etc-cloud.com%2Fyunnan_bindBank').startsWith('http'))